...
public class NoticeContents extends GhostActionBarActivity {
    ...
    private void setBasicLayout() {
        ...
        /* 매니져 클래스 생성 */
        manager = new ClassNoticeManager(getApplicationContext(), url);
        manager.getNcheck();
    ...
    private class GetArticle extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            // show(띄울 액티비티, 타이틀, 내용)
            getArticleDialog = ProgressDialog.show(NoticeContents.this, "", "해당 공지글을 불러오는 중입니다.. \n기다려주세요");
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equals("success")) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(NoticeContents.this);
                builder.setTitle("한동어플");
                builder.setMessage("서비스를 준비중입니다.")
                        .setCancelable(false)
