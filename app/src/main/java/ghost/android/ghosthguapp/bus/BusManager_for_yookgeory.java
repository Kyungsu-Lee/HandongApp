...
public class BusManager_for_yookgeory {
    private ArrayList<BusData> busList;
    private File file = GlobalVariables.fSix;
    ...
    public boolean checkNSave() {
        ...
        if (file.exists()) {
            ...
            try {
                ...
                URL Url = new URL(GlobalVariables.SERVER_ADDR + "bus/getBus_Weekday%28toSix%29.jsp");
