...
public class Bus_to_yookgeory_mal extends Fragment {
    ImageButton alarm;
    Button go_to_school_button;
    Button go_to_heunghae, bus_location;
    private ListView lv_bus;
    private BusAdapter_for_yookgeory_mal adapter;
    private Activity thisActivity;
    private Context con;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup fragment_container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.bus_layout_for_yookgeory, fragment_container, false);
        thisActivity = getActivity();
        con = thisActivity.getApplicationContext();
        TextView zoomal = (TextView) rootView.findViewById(R.id.pyeongill_or_zoomal);
        zoomal.setText("주말");

        go_to_school_button = (Button) rootView.findViewById(R.id.go_to_school_button);
        go_to_school_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((Tabs_for_bus) thisActivity).setSy(0);
        ...
        go_to_heunghae = (Button) rootView.findViewById(R.id.go_to_heunghae);
        ...
        alarm = (ImageButton) rootView.findViewById(R.id.imageButton);
        ...
        bus_location = (Button) rootView.findViewById(R.id.bus_location);
        bus_location.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(thisActivity, Bus_to_yookgeory_location.class);
                startActivity(i);
            }
        });
        ...
        //인터넷 안되면
            ...
            //파일이 없으면 : 에러 다이얼로그 띄움
            if (!GlobalVariables.fSixMal.exists()) {
    ...
    private class DoCheckAndSave extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... arg0) {
            // TODO Auto-generated method stub
            BusManager_for_yookgeory_mal busManager = new BusManager_for_yookgeory_mal();
    ...
    private void display() {
        ...
        // adapter setting
        adapter = new BusAdapter_for_yookgeory_mal(con, thisActivity, R.layout.eachhangmok_for_bus, arrayforbusdata);
        // adapter register
