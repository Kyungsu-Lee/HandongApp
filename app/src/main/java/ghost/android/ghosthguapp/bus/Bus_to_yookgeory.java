...
public class Bus_to_yookgeory extends Fragment {
    ImageButton alarm;
    Button go_to_school_button;
    Button go_to_heunghae, bus_location;
    private ListView lv_bus;
    private BusAdapter_for_yookgeory adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup fragment_container,
        ...
        //인터넷 안되면
            ...
            //파일이 없으면 : 에러 다이얼로그 띄움
            if (!GlobalVariables.fSix.exists()) {
    ...
    private class DoCheckAndSave extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... arg0) {
            // TODO Auto-generated method stub
            BusManager_for_yookgeory busManager = new BusManager_for_yookgeory();
    ...
    private void display() {
        ...
        // adapter setting
        adapter = new BusAdapter_for_yookgeory(con, thisActivity, R.layout.eachhangmok_for_bus, arrayforbusdata);
        // adapter register
