...
public class BusManager_for_yookgeory_mal {
    private ArrayList<BusData> busList;
    private File file = GlobalVariables.fSixMal;
    ...
    public boolean checkNSave() {
        ...
        if (file.exists()) {
            ...
            try {
                ...
                URL Url = new URL(GlobalVariables.SERVER_ADDR + "bus/getBus_Weekend%28toSix%29.jsp");
