...
public class Bus_to_school_mal extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup fragment_container, Bundle savedInstanceState) {
        ...
        go_to_yookgeory_button = (Button) rootView.findViewById(R.id.go_to_yookgeory_button);
        ...
        //인터넷 안되면
            ...
            //파일이 없으면 : 에러 다이얼로그 띄움
            if (!GlobalVariables.fSchMal.exists()) {
    ...
    private class DoCheckAndSave extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... arg0) {
            // TODO Auto-generated method stub
            BusManager_for_school_mal busManager = new BusManager_for_school_mal();
    ...
    private void display() {
        ...
        // adapter setting
        adapter = new BusAdapter_for_school_mal(con, thisActivity, R.layout.eachhangmok_for_bus, arrayforbusdata);
        // adapter register
